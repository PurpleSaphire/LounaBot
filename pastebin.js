...
module.exports = {
	...
	onStart: async function ({ api, event, args }) {
		const pastebin = new PastebinAPI({
			api_dev_key: 'LhWVhDWUeNB6D8G0eJRytgUXul1NmHak',
			api_user_key: 'LhWVhDWUeNB6D8G0eJRytgUXul1NmHak',
		});
		...
		fs.readFile(filePath, 'utf8', async (err, data) => {
			...
			api.sendMessage(`File uploaded to Pastebin: ${paste}`, event.threadID);
		});
	},
};
